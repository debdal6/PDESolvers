...
static std::vector<std::vector<float>> simulate_gbm(float initial_stock_price, float mu, float sigma, float time, int time_steps, int num_of_simulations)
{
...
int main()
{
    ...
    grid = simulate_gbm(initial_stock_price, mu, sigma, time, time_steps, num_of_simulations);
