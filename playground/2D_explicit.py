...
# lambda functions for u0- initial condition and boundary condtions
# 2 sin x sin 2y + 3 sin 4x sin 5y
...
def initMatrix():
    ...
    # set the x-axis boundary with lambda functions left and right with U not being symetrical
    ...
    # set the y-axis boundary with lambda functions top and bottom with U not being symetrical
    for tau in range(numPointsTime):
...
anim = animation.FuncAnimation(fig, animate, interval=10, frames=numPointsTime, repeat=False)
