...
def explicit2d(u0, left, right, top, bottom, 
               xLength=50, yLength=50, maxTime=2, diffusivityConstant=1, numPointsSpace=100, numPointsTime=200,
               doPlot=False):ṇ
    """
    2D Heat Equation Solver using the explicit method

    Arguments:
    u0: function, initial condition
    left: function, left boundary condition
    right: function, right boundary condition
    top: function, top boundary condition
    bottom: function, bottom boundary condition
